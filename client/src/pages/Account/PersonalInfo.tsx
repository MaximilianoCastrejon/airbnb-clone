    ...
    <div className="max-w-5xl px-6 mx-auto mb-12">
      <div className="my-5">
        <p className="font-medium text-neutral-600">
          <span className="cursor-pointer">Account</span> &gt; Personal info
        </p>
        <p className="text-4xl text-neutral-600 font-bold">Personal info</p>
      </div>
      <div className="grid grid-cols-10">
        <div className="col-span-6 flex flex-col">
          <div className="flex flex-row border-b-2 border-gray-200 w-full py-6">
            <div className="flex flex-col flex-1">
              <p>Legal name</p>
              <p className="font-light">{userContext?.username}</p>
            </div>
            <div>
              <p className="ml-2 cursor-pointer underline decoration-1 font-medium">
                Edit
              </p>
            </div>
          </div>
        ...
        <div className="col-span-3 ">
          <div className="rounded-lg border border-gray-200 p-6">
            <div className="border-b-2 border-gray-200 mb-8">
              ...
              <p className="font-bold text-xl text-neutral-800 mt-4">
            ...
            <div className="border-b-2 border-gray-200 my-8">
              ...
              <p className=" text-base text-neutral-500 mt-4">
                ...
                was used to verify your identity, you&#39;ll need to get
                verified again the next time you book—or to continue hosting.
              </p>
            </div>
            <div className="mt-8">
              <svg
